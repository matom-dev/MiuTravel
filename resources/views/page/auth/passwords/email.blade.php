...
@section('title', 'Quên mật khẩu | Miu Travel')
@section('style')
<style>
.pw-wrap {
    background: #f7f3ef;
        ...
        <div class="row no-gutters slider-text align-items-end justify-content-start" style="min-height:200px;padding-bottom:30px;">
            <div class="col-md-9 ftco-animate pb-5 text-left">
                <p class="breadcrumbs">
                    ...
                    <span>Quên mật khẩu <i class="fa fa-chevron-right"></i></span>
                </p>
    ...
    <div class="container">
        <div class="pw-card">
            <div class="pw-head">
                ...
                <p>Nhập email tài khoản, Miu Travel sẽ gửi liên kết đặt lại mật khẩu cho bạn.</p>
            </div>
            <div class="pw-body">
                @if (session('status'))
                ...
                <form method="POST" action="{{ route('page.user.password.email') }}">
                    @csrf
                    <div class="pw-field">
                        <label for="pw-email">Địa chỉ Email <sup>*</sup></label>
                        <div class="pw-input">
                    ...
                    <button type="submit" class="pw-submit">
                        <i class="fa fa-paper-plane"></i> Gửi link đặt lại mật khẩu
                    </button>
                </form>
