...
class CommentController extends Controller
{
    ...
    {
        //
        $comments = Comment::with(['user', 'article', 'tour', 'hotel'])->whereIn('cm_user_id', function ($q) use($request) {
    ...
    {
        if (!array_key_exists((int) $status, Comment::STATUS)) {
            return redirect()->back()->with('error', 'Trạng thái bình luận không hợp lệ');
        }
